    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4 bg-light min-vh-100">
            <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
                ...
                <a href="index.php?controller=admin&action=addPost" class="btn btn-brand shadow-sm">
                                ...
                                <?php foreach($posts as $row): ?>
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <a href="index.php?controller=admin&action=editPost&id=<?php echo $post['id']; ?>" class="btn btn-sm btn-light text-primary rounded-circle"><i class="fas fa-edit"></i></a>
                                            <a href="index.php?controller=admin&action=deletePost&id=<?php echo $post['id']; ?>" onclick="return confirm('Xóa bài viết này?')" class="btn btn-sm btn-light text-danger rounded-circle"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
