                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="<?php echo $key; ?>" id="perm_<?php echo $key; ?>" <?php echo $checked; ?>>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function togglePermissions() {
        if (roleSelect.value === '2') {
            ...
            // Không bỏ check ở trang Edit vì lỡ tay chọn nhầm Admin rồi chọn lại Staff sẽ mất quyền cũ
        }
    }
