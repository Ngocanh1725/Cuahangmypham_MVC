                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="is_flash_sale" value="1" id="flash_sale" <?php echo (!empty($product['is_flash_sale'])) ? 'checked' : ''; ?>>
                                                <label class="form-check-label" for="flash_sale">Flash Sale</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="is_trending" value="1" id="trending" <?php echo (!empty($product['is_trending'])) ? 'checked' : ''; ?>>
                                                <label class="form-check-label" for="trending">Xu Hướng Làm Đẹp</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="is_summer" value="1" id="summer" <?php echo (!empty($product['is_summer'])) ? 'checked' : ''; ?>>
