...
$pageTitle = "Đăng ký tài khoản - Glow Cosmetics"; 
                ...
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <!-- Icon User nổi bật -->
                            <i class="fas fa-user-plus fa-4x mb-3" style="color: var(--brand-dark, #be185d);"></i>
                            <h3 class="fw-bold text-dark mb-1">Đăng Ký Thành Viên</h3>
                            <p class="text-muted small">Tạo tài khoản để mua sắm và nhận ưu đãi!</p>
                        </div>
                        
                        <!-- Hiển thị thông báo lỗi từ Controller truyền sang -->
                        <?php if(!empty($message)) echo $message; ?>

                        <!-- Form gửi dữ liệu về UserController, action register -->
                        <form method="POST" action="index.php?controller=user&action=register">
                            <div class="mb-3">
                                ...
                                <div class="input-group shadow-sm rounded-pill overflow-hidden">
                                    <span class="input-group-text bg-white border-end-0 text-muted ps-4"><i class="fas fa-user"></i></span>
                                    <input type="text" name="fullname" class="form-control border-start-0 py-2 shadow-none" required placeholder="Nhập họ tên...">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-secondary small text-uppercase">Xác nhận Mật khẩu</label>
                                <div class="input-group shadow-sm rounded-pill overflow-hidden">
                                    <span class="input-group-text bg-white border-end-0 text-muted ps-4"><i class="fas fa-lock"></i></span>
                                    <input type="password" name="confirm_password" class="form-control border-start-0 py-2 shadow-none" required placeholder="******">
                                </div>
                            </div>

                            <button type="submit" class="btn text-white w-100 py-3 fw-bold rounded-pill shadow-sm mb-3" style="background-color: var(--brand-main, #db2777); transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--brand-dark, #be185d)'" onmouseout="this.style.backgroundColor='var(--brand-main, #db2777)'">
                        ...
                        <div class="text-center mt-3 border-top pt-3">
                            ...
                            <a href="index.php?controller=user&action=login" class="text-decoration-none fw-bold" style="color: var(--brand-main, #db2777);">Đăng nhập ngay</a>
                        </div>
